#!/usr/bin/env python3
"""Module that calculates binomial intersection values."""

import numpy as np


def intersection(x, n, P, Pr):
    """Calculate the intersection of data and hypothetical probabilities.
    ...
    Returns:
        numpy.ndarray: Intersection of obtaining ``x`` out of ``n`` and each
        probability in ``P``.
    """
